(function() {
  ...
  /** @ngInject */
  function Szablon6Controller($timeout, webDevTec, toastr) {
    var vm = this;
    vm.awesomeThings = [];
    vm.classAnimation = '';
    vm.room = '';
    ...
    // vm.images = [{'thumb': '1.png'},{'thumb': '2.png'},{'thumb': '3.png'},{'thumb': '4.png'}]
    vm.list1 = [{'thumb': '1.png'},{'thumb': '2.png'},{'thumb': '3.png'},{'thumb': '4.png'},{'thumb': '5.png'},{'thumb': '6.png'}];
    // angular.forEach(vm.images, function(val, key) {
    //     vm.list1.push({});
    // });
    vm.list2 = [
        { 'title': 'Zarowka', 'drag': true },
        { 'title': 'Dioda', '   drag': true },
        { 'title': 'Przelacznik', 'drag': true },
        { 'title': 'Panel', 'drag': true }
    ];
